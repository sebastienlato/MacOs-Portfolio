...
/**
 * The Home Screen: a page of apps, the greeting, the search pill and the dock.
 * There is no second page and so no page dots — iOS only draws them once there
 * is somewhere to swipe to.
 *
